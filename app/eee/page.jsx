...
import EEEnews from "../components/CSEnews";
import Carousel from "../components/ui/carousal";
import Announcement from "../components/EEEannouncement";
import Events from "../components/EEEevents";
import Banner from "../components/banner1";
import Navbar from "../components/navbar1";
import Footer from "../components/footer";
const CSE = () => {
  const [nav, setNav] = useState(true);
  const newsItems = EEEnews();
      ...
      <div className="w-full h-auto bg-gray-500 text-black font-bold px-5 @lg:px-12 lg:px-20 py-10">
        <section className="flex flex-col lg:flex-row h-auto w-full my-20">
          ...
          <div className=" relative   w-full lg:w-1/2 lg:px-10 flex justify-center ">
            ...
            <img
              src="https://i.pinimg.com/564x/cc/a9/a3/cca9a3759273d6fce83d4d0dab9d8844.jpg"
              alt=""
