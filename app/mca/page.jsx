        ...
        <section className="flex flex-col lg:flex-row h-auto w-full my-20">
          <div className="md:mt-0 mt-20 w-full lg:w-1/2">
            <h1 className="mx-20 text-3xl md:text-4xl lg:text-4xl font-semibold text-white max-w-m">
              ...
              <span className="text-lime-500">Computer Applications</span>
            </h1>
            <p className="text-white text-lg lg:text-base mt-5">
            Begin with the most comprehensive and cutting-edge curriculum to learn and excel in Master of Computer Applications (MCA). Start your journey today and become proficient in the latest technologies and innovations in the field!
            </p>
          ...
          <div className=" relative   w-full lg:w-1/2 lg:px-10 flex justify-center ">
            ...
            <img
              src="https://i.pinimg.com/736x/40/53/8c/40538c3c1ebe9bb811bb625a4bbf178c.jpg"
              alt=""
