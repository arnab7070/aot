...
export default function BentoGridDemo({ dept="csbs" }) {
  // Sample events data
  const items = [
    {
      ...
      dept: ["cse","csbs","eee","ece","ee","me"],
    },
    {
      title: "Upcoming Exam Schedule",
      description: "Final exams are from June 10th to 28th. Check the student portal for the timetable.",
  ...
  const filteredItems = items.filter(item => item.dept.includes(dept));
