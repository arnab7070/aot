      ...
      <div className="md:px-5 p-2">
        <Tabs defaultValue="faculty">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="faculty_data" className="">
              Faculty Profile
            </TabsTrigger>
          </TabsList>
                    ...
                    <article className="projects__card" key={faculty.Name}>
                      ...
                      <div className="projects__content">
                        ...
                        <p className="projects__description">
                          {faculty.Qualification} with {faculty.Experience} of
                          experience.
                        </p>
                      </div>
          ...
          >
            ...
            <div className="md:p-5">
              ...
              <p className="my-5 text-lg">
                AOT believes in creating an environment that helps the students
                to enhance their intellectual, emotional and physical
                development.
              </p>
              <p className="text-lg">
                Prof. (Dr.){" "}
                <span className={courgette.className}>Dilip Bhattacharya</span>,
                renowned Professor of Electronics & Electrical Communication
                Engineering from IIT Kharagpur and the Director of Academy of
                Technology, leads a team of 111 qualified and experienced
                faculty members conforming to AICTE stipulated teacher-student
                ratio.
              </p>
              <ul className="space-y-4 mt-5 ">
                <li className="flex font-semibold">
                  {" "}
                  <BadgeCheck className="mr-2" /> 81 regular faculty members are
                  having specialization in Industry 4.0 Technologies.
                </li>
                <li className="flex font-semibold">
                  {" "}
                  <BadgeCheck className="mr-2" /> Average teaching experience of
                  faculty members is 11 years 8 months.
                </li>
                <li className="flex font-semibold">
                  {" "}
                  <BadgeCheck className="mr-2" /> Faculty members of AOT have
                  published 84 papers in various International & National
                  Journals.
                </li>
                <li className="flex font-semibold">
                  {" "}
                  <BadgeCheck className="mr-2" /> Existing faculty members of
                  AOT have authored 11 books.
                </li>
              </ul>
            </div>
          </TabsContent>
